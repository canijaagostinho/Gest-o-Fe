  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: cn(
          "flex items-center justify-center h-[var(--cell-size)] w-full px-0", // px was using cell-size but usually caption doesn't need that much padding? matched original logic: px-(--cell-size) => px-[var(--cell-size)]
